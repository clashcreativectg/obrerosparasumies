...
if (firebaseGrid) {
  ...
  onSnapshot(q, (snapshot) => {
    firebaseGrid.innerHTML = ""; // Reseteamos el contenedor "Cargando..."
    ...
    snapshot.forEach((doc) => {
      ...
      // Determinamos si inyectamos una etiqueta <video> o un iframe de YouTube
      let mediaHtml = "";
      ...
      // Convertimos el timestamp de Firebase a texto elegante
      ...
      // Inyección del markup respetando tus clases
      mediaCard.innerHTML = `
        ...
        <div class="media-card__body">
          <div class="media-card__meta">
            ...
            <span class="media-card__tag">
              <i class="${data.type === 'youtube' ? 'fab fa-youtube' : 'fas fa-video'}"></i> ${data.type === 'youtube' ? 'YouTube' : 'Video Local'}
            </span>
          </div>
